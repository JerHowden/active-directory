...
#>
#Requires -Module SDM-GPMC
Add-Type -AssemblyName System.DirectoryServices.Protocols
#Import-Module SDM-GPMC
$secGPOs
$lugsGPOs
$ListFoundGPOs = $null
$ListFoundGPOs = New-Object 'System.Collections.Generic.List[System.Object]'
function Get-VulnerableGPO
{
    ...
    Process
    {
        ...
        $AreasPol.Add("Computer Configuration|Policies|Windows Settings|Security Settings|Local Policies|User Rights Assignment|Allow log on locally","User Rights Assignment--Allow Logon Locally")
        $AreasPol.Add("Computer Configuration|Policies|Windows Settings|Security Settings|Local Policies|User Rights Assignment|Allow log on through Remote Desktop Services","User Rights Assignment--Allow log on through Remote Desktop Services")
        $AreasPol.Add("Computer Configuration|Policies|Windows Settings|Security Settings|Local Policies|User Rights Assignment|Deny log on locally","User Rights Assignment--Deny Logon Locally")
        $AreasPol.Add("Computer Configuration|Policies|Windows Settings|Security Settings|Local Policies|User Rights Assignment|Deny log on as a service","User Rights Assignment--Deny Logon As A Service")
        $AreasPol.Add("Computer Configuration|Policies|Windows Settings|Security Settings|Local Policies|User Rights Assignment|Deny log on as a batch job","User Rights Assignment--Deny Logon As A Batch Job")
        $AreasPol.Add("Computer Configuration|Policies|Windows Settings|Security Settings|Local Policies|User Rights Assignment|Deny access to this computer from the network","User Rights Assignment--Deny Access to this Computer from the network")
