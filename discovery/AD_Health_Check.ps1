...
(
    ...
    [ValidateSet("Full","Limited")][string]$Scope = 'Limited'
)

# Version
[string]$ScriptVersion = 'v1.14'
...
function Get-DFSROutbandInfo
{
    ...
    $dfsrOutbandInfos = New-Object psobject 
    $dfsrOutbandInfos | Add-Member noteproperty ReplicationGroupName $replicationGroupName
    $dfsrOutbandInfos | Add-Member noteproperty ReplicatedFolderName $replicatedFolderName
    $dfsrOutbandInfos | Add-Member noteproperty SendingMember $computer.ToLower()
    $dfsrOutbandInfos | Add-Member noteproperty ReceivingMember ''
    $dfsrOutbandInfos | Add-Member noteproperty BacklogCount ''
    $dfsrOutbandInfos | Add-Member noteproperty FolderEnabled ''
    $dfsrOutbandInfos | Add-Member noteproperty ConnectionEnabled ''
...
{
    Add-Content -Path $logFilename -Value ([string](Get-Date) + " --- " + $log) -PassThru
}
#======================================================================================== 
    ...
    if ($script:testConnection)
    {
        ...
        else
        {
            ...
            switch ($statusCode)
            {
                ...
                '11001' { [string]$pingResult = 'Request Timed Out'; [bool]$pingOk = $false }
...
function Test-WMI
{
    ...
    try
    {
        ...
        [DateTime]$t1 = Get-Date
        $wmiObject = Get-WmiObject -namespace $namespace -class $class -computername $computername -ErrorAction SilentlyContinue
        [string]$serialNumber = ($wmiObject | Select-Object SerialNumber).SerialNumber
        # if server does not respond to RPC than $wmiObject is $null
        if (($serialNumber -ne $null) -and ($wmiObject -ne $null))
        {
...
function New-DC()
{
    ...
    $dc | Add-Member -Type NoteProperty -Name ComputerName -Value $ComputerName
    $dc | Add-Member -Type NoteProperty -Name FQDN -Value $FQDN
    $dc | Add-Member -Type NoteProperty -Name PingFQDN -Value $PingFQDN
    $dc | Add-Member -Type NoteProperty -Name PingShortname -Value $PingShortname
    $dc | Add-Member -Type NoteProperty -Name LDAPBind -Value $LDAPBind
    $dc | Add-Member -Type NoteProperty -Name WMI -Value $WMI
    $dc | Add-Member -Type NoteProperty -Name TCPPort88 -Value $TCPPort88
    $dc | Add-Member -Type NoteProperty -Name TCPPort135 -Value $TCPPort135
    $dc | Add-Member -Type NoteProperty -Name TCPPort389 -Value $TCPPort389
    $dc | Add-Member -Type NoteProperty -Name TCPPort445 -Value $TCPPort445
    $dc | Add-Member -Type NoteProperty -Name TCPPort3268 -Value $TCPPort3268
    $dc | Add-Member -Type NoteProperty -Name OS -Value $OS
    $dc | Add-Member -Type NoteProperty -Name IsGlobalCatalog -Value $IsGlobalCatalog
    return $dc
}
#======================================================================================== 
...
function New-Domain() 
{
    ...
    $domain | Add-Member -Type NoteProperty -Name DomainName -Value $DomainName
    $domain | Add-Member -Type NoteProperty -Name DomainMode -Value $DomainMode
    $domain | Add-Member -Type NoteProperty -Name PdcRoleOwner -Value $PdcRoleOwner
    $domain | Add-Member -Type NoteProperty -Name RidRoleOwner -Value $RidRoleOwner
    $domain | Add-Member -Type NoteProperty -Name InfrastructureRoleOwner -Value $InfrastructureRoleOwner
    $domain | Add-Member -Type NoteProperty -Name RidsRemainingPercent -Value $RidsRemainingPercent
    return $domain
}
#======================================================================================== 
...
function New-Site() 
{
    ...
    $site | Add-Member -Type NoteProperty -Name SiteName -Value $siteName
    $site | Add-Member -Type NoteProperty -Name InterSiteTopologyGenerator -Value $interSiteTopologyGenerator
    $site | Add-Member -Type NoteProperty -Name Subnets -Value $subnets
    $site | Add-Member -Type NoteProperty -Name Servers -Value $servers
    $site | Add-Member -Type NoteProperty -Name AdjacentSites -Value $adjacentSites
    $site | Add-Member -Type NoteProperty -Name SiteLinks -Value $siteLinks
    $site | Add-Member -Type NoteProperty -Name BridgeheadServers -Value $bridgeheadServers
    return $site
}
#======================================================================================== 
...
function New-Replication() 
{
    ...
    $replication = New-Object PSObject
    $replication | Add-Member -Type NoteProperty -Name SourceOrDestination  -Value $SourceOrDestination 
    $replication | Add-Member -Type NoteProperty -Name ComputerName  -Value $ComputerName 
    $replication | Add-Member -Type NoteProperty -Name LargestDelta  -Value $LargestDelta 
    $replication | Add-Member -Type NoteProperty -Name ReplicationFailed  -Value $ReplicationFailed 
    $replication | Add-Member -Type NoteProperty -Name ReplicationTotal  -Value $ReplicationTotal 
    return $replication
}
#======================================================================================== 
...
function New-Gpo() 
{
    ...
    $gpo | Add-Member -Type NoteProperty -Name Domain  -Value $Domain 
    $gpo | Add-Member -Type NoteProperty -Name Guid  -Value $Guid 
    $gpo | Add-Member -Type NoteProperty -Name Name  -Value $Name 
    $gpo | Add-Member -Type NoteProperty -Name Status  -Value $Status 
    return $gpo
}
#======================================================================================== 
...
function New-Backup() 
{
    ...
    $backup | Add-Member -Type NoteProperty -Name Partition  -Value $Partition 
    $backup | Add-Member -Type NoteProperty -Name LastBackupTime  -Value $LastBackupTime 
    return $backup
}
#======================================================================================== 
...
function New-Diagnosis() 
{
    ...
    $diagnosis = New-Object PSObject
    $diagnosis | Add-Member -Type NoteProperty -Name Target  -Value $Target 
    $diagnosis | Add-Member -Type NoteProperty -Name Test  -Value $Test 
    $diagnosis | Add-Member -Type NoteProperty -Name Result  -Value $Result 
    return $diagnosis
}
#======================================================================================== 
...
foreach ($DC in $DCs)
{
    ...
    if ($connection[0])
    {
        ...
        if ($wmiTest[0])
        {
            ...
            Write-Log ('        Elaspe Time = ' + $wmiTest[2] + ' ms')
        }
        else
        {
            [string]$wmi = 'Failed'
...
$subtitle += ("{0:yyyy-MM-dd HH:mm}" -f $currentDate)
$subtitle += ' (' + ("{0:yyyy-MM-dd HH:mm}" -f $currentDate.ToUniversalTime()) + ' UTC)'
...
$htmlCode += '</thead>'
$htmlCode += '<tbody>'
$htmlCode += '    <tr class="even"><td>' + $forestName + '</td><td>' + $forestMode + '</td><td>' + $schemaRoleOwner + '</td><td>' + $namingRoleOwner + '</td><td>' + $numberOfDCs + '</td><td>' + $numberOfDomains + '</td><td>' + $numberOfSites + '</td><td>' + $numberOfSitesWithDC + '</td></tr>'
$htmlCode += '</tbody>'
$htmlCode += '</table>'
$htmlCode += ''
$htmlCode += ''
...
if ($scope.ToLower() -eq 'full')
{
    $htmlCode += '    <tr><th>Computer Name</th><th>FQDN</th><th>OS</th><th>GC</th><th>Ping FQDN</th><th>Ping Short Name</th><th>LDAP Bind</th><th>WMI</th><th>TCP Port 88</th><th>TCP Port 135</th><th>TCP Port 389</th><th>TCP Port 445</th><th>TCP Port 3268</th></tr>'
}
else
{
    $htmlCode += '    <tr><th>Computer Name</th><th>FQDN</th><th>Ping FQDN</th><th>Ping Short Name</th><th>LDAP Bind</th><th>WMI</th><th>TCP Port 88</th><th>TCP Port 135</th><th>TCP Port 389</th><th>TCP Port 445</th><th>TCP Port 3268</th></tr>'
}
$htmlCode += '</thead>'
$htmlCode += '<tbody>'
